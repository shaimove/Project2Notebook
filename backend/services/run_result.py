...
def assemble_artifacts(state: DataScientist) -> Dict[str, Any]:
    ...
    artifacts: Dict[str, Any] = {
        ...
        "split_plotly_html": state.get("split_plotly_html"),
        "split_ratios": state.get("split_ratios"),
        ...
        "html_plots": [Path(p).name for p in artifact_store.list_html_plots(project_id)],
